...
<head>
  ...
  <title>CodeIgniter-Shop | <?= $title; ?></title>
...
<ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
	...
	<a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>Admin">
		<div class="sidebar-brand-icon rotate-n-15">
			<img src="<?= base_url() ?>assets/Users/img/icon.png" alt="logo">
		</div>
		<div class="sidebar-brand-text mx-3">TL-Admin</div>
	</a>
	...
	<li class="nav-item">
		<a class="nav-link" href="<?= base_url() ?>Kota">
			<i class="fas fa-fw fa-globe-asia"></i>
			<span>Data Provinsi dan Kota</span></a>
	</li>
