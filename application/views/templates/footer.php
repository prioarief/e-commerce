				...
				<form action="<?= base_url() ?>Transaksi/Cart" method="post">
					<div class="col-sm form-group">
						...
						<div class="product_count">
							...
							<button onclick="var result = document.getElementById('quantity'); var quantity = result.value; if( !isNaN( quantity )) result.value++;return false;" class="increase items-count" type="button"><i class="lnr lnr-chevron-up text-danger"></i></button>
							<button onclick="var result = document.getElementById('quantity'); var quantity = result.value; if( !isNaN( quantity ) &amp;&amp; quantity > 1 ) result.value--;return false;" class="reduced items-count" type="button"><i class="lnr lnr-chevron-down text-danger"></i></button>
						</div>
					</div>
				...
				<form action="<?= base_url() ?>Transaksi/UpdateCart" method="post">
					<div class="col-sm form-group">
						...
						<div class="product_count">
							...
							<button onclick="var result = document.getElementById('quantityy'); var quantityy = result.value; if( !isNaN( quantityy )) result.value++;return false;" class="increase items-count" type="button"><i class="lnr lnr-chevron-up text-danger"></i></button>
							<button onclick="var result = document.getElementById('quantityy'); var quantityy = result.value; if( !isNaN( quantityy ) &amp;&amp; quantityy > 1 ) result.value--;return false;" class="reduced items-count" type="button"><i class="lnr lnr-chevron-down text-danger"></i></button>
						</div>
					</div>
