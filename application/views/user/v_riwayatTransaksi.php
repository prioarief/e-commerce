<div class="container mt-5 mb-5">
        <div class="row">
            ...
            <ul>
                ...
                <div class="col-sm">
                    <h4 class="text-center mt-3 mb-3">Riwayat Transaksi</h4>
                ...
                <li class="list-group-item mb-2 bg-light boxxx">
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <!-- <a class="btn btn-success btn-sm mb-1 float-right ml-2" href="<?= base_url() ?>" title="Konfirmasi Pesanan"><span class="lnr lnr-checkmark-circle"></span></a> -->
